...
{
    public class Notificacion_R : Notificacion_I
    {
        private readonly DatabaseService _context;

        public Notificacion_R(DatabaseService context)
        {
        ...
        public async Task<Notificacion> GetNotificacionById(int id) =>
            await _context.Notificacion.FirstOrDefaultAsync(n => n.Idnotificacion == id);
